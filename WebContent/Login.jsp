	...
	<body>
		<div id="page">
			<header id="header">
				<div id="header-inner">	
					<div id="logo">
						<h1><a href="#">Clinica<span> GSG</span></a></h1>
					</div>
					<div id="top-nav">
						<ul>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"><b>Inserisci Codice :</b></label>  
  <div class="col-md-4">
  <input id="textinput" name="textinput" type="text" placeholder="Codice" class="form-control input-md" required="">
...
<!-- Password input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="passwordinput"><b>Inserisci Password :</b></label>
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="singlebutton" name="singlebutton" class="btn btn-primary">Accedi</button>
  </div>
</div>
			...
			<div id="footerblurb">
				<div id="footerblurb-inner">
					...
					<div class="text" >
						<h2><span>Crediti</span></h2>
						<p>Questo sito è stato sviluppato da Riccardo Grasselli , Federico Giulianelli , Simone Sanò.</p>
					</div>	
